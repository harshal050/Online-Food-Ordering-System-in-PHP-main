...
<body>
    ...
    <input type="button" onclick="window.location.href = 'http://localhost/Online-Food-Ordering-System-in-PHP-main/index1.php';" class="btn btn-success btn-block" value="Stripe">
</p>
